...
\eeq
	In future, for determination of the BPS spectrum, we will need the values of the superpotential
...
\eeq
	...
	The phenomenon of the occurence of a fractional charge is well-known \cite{Jackiw:1975fn,ls1,Shifman:2005rs,Shifman:2007ce}, 
...
\eeq
	...
	Therefore in the CP(1) model there is an agreement between our spectrum and the known quasi-classical results.
	Recovery of the weak-coupling spectrum in a general CP($N-1$) theory via semi-classical methods 
